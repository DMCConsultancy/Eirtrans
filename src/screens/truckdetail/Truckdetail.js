                                ...
                                <View style={styles.cardsty}>
                                    ...
                                    <View style={styles.row}>
                                        ...
                                        <View style={styles.card60}>
                                            <Text style={styles.label}>{state.data[0]?.post_code}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.row}>
                                        ...
                                        <View style={styles.card60}>
                                            <Text style={styles.label}>{state.data[0]?.collectionaddress}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.row}>
                                        ...
                                        <View style={styles.card60}>
                                            <Text style={styles.label}>{state.info?.delivery_address}</Text>
                                        </View>
                                    </View>
