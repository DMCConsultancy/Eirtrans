...
import { Text, View, Button, Image, StatusBar, TextInput, ImageBackground, Modal, TouchableOpacity } from "react-native";
...
class Login extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            selectedDriver:'',loginStatus:false,
            data:[],visible:false,
            error_pin: false,
            pin:'',message:''
        }
        ...
        return (
            <Container style={styles.container}>
                    ...
                    <View style={styles.content}>
                        ...
                        <View>
                            ...
                            {this.state.error_pin==true?(
                               <Error name="error" color="red" size={25} style={styles.iconsty}/>
                            ):null}
                        </View>
                ...
                <MyModal
                    ...
                    onRequestClose={() => this.setModalVisible(!this.state.modalVisible_alert)}/>
                    ...
                    <Modal
                        ...
                        <View style={styles.modalView}>
                            ...
                            <TouchableOpacity onPress={()=>this.loginModal(!this.state.visible)}
                            style={styles.btnsty}>
