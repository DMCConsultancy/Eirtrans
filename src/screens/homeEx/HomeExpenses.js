...
export default class Expenses extends Component{
    ...
    constructor(props){
        ...
        this.state={
            expense:"",
            dob:"",show:false,modalVisible_alert1:false,
    ...
    render(){
        return(
           <Container style={[styles.container,{backgroundColor:"skyblue"}]}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.mt20}>
                      ...
                      <TextInput placeholder="Enter Exp Desc"
                      style={styles.input}
                    ...
                    <View style={[styles.row,styles.mt20]}>
                        ...
                        <TouchableOpacity style={styles.box} 
                         onPress={()=> {this.setModalVisible1(!this.state.modalVisible_alert1)
                         }}>
                          ...
                          <View style={styles.mt20}>
                           ...
                           <TouchableOpacity onPress={()=>{
                            ...
                            this.screenShotModal(!this.state.modal_alert)}}>
                              ...
                              <View style={styles.mt20}>
                           <TouchableOpacity onPress={()=>this.screenShotModal(!this.state.modal_alert)}>
          ...
          onBackdropPress={() =>  this.setModalVisible1(!this.state.modalVisible_alert1)}
          onRequestClose={() => {
